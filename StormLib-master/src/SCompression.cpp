...
static void Compress_LZMA(void * pvOutBuffer, int * pcbOutBuffer, void * pvInBuffer, int cbInBuffer, int * pCmpType, int nCmpLevel)
{
    ...
    Progress.Progress = (SRes(*__cdecl)(const ICompressProgress*, UInt64, UInt64))(LZMA_Callback_Progress);
    SzAlloc.Alloc = (void* (*__cdecl)(ISzAllocPtr, size_t))LZMA_Callback_Alloc;
    SzAlloc.Free = (void (*__cdecl)(ISzAllocPtr, void*))LZMA_Callback_Free;
